    	...
    	<div id="page_middle_content">
            	...
            	<div id="profile_menu_rest">
           		...
           		<div id="profile_menu">
                	<div id="menu2">
                        ...
                        <a href="timeline.php" class="active">Timeline</a><span style="font-size:70px;position:relative;top:-26px;font-family:Edwardian Script ITC">|</span>
                		<a href="about.php">About</a><span style="font-size:70px;position:relative;top:-26px;font-family:Edwardian Script ITC">|</span>
                		<a href="friends.php">Friends</a><span style="font-size:70px;position:relative;top:-26px;font-family:Edwardian Script ITC">|</span>
    		...
    		<div id="body_content_center">
            	<div id="box">
    				<div id="head">
        				<div id="title">
                			<a href="#" class="active1">Update Status</a>  
                            <a href="#">Add Photo</a> 
            			</div>
        			</div>
   					<div id="element">
